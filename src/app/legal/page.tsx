      ...
      <div className="space-y-8">
        ...
        <Card className="shadow-lg">
         ...
         <Card className="shadow-lg mt-8">
            ...
            <p>Website: <Link href="/legal" className="text-accent hover:underline">marpu.org/legal</Link></p>
            <p>Mailing Address: 123 Change St, Progress City, Nation 12345</p>
            <p>Email: <a href="mailto:legal@marpu.org" className="text-accent hover:underline">legal@marpu.org</a></p>
