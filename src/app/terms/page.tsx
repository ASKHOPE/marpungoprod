        ...
        <Card className="shadow-lg">
          ...
          <CardContent className="text-foreground/80 text-justify">
            ...
            <ul className="list-disc list-inside space-y-1 mt-2 pl-4">
              <li>By email: <a href="mailto:terms@marpu.org" className="text-accent hover:underline">donate@marpu.ngo</a></li>
              <li>By visiting this page on our website: <Link href="/contact" className="text-accent hover:underline">marpu.ngo/contact</Link></li>
              <li>By mail: East Godavari District,Andhra Pradesh,India</li>
            </ul>
          </CardContent>
        </Card>
      </div>
